    ...
    <div className="relative w-full bg-white">
      <div className="mx-auto flex max-w-75xl items-center justify-between px-4 py-2 sm:px-6 lg:px-6">
        ...
        <div className="hidden grow items-start lg:flex">
          ...
          <button
            type="button"
            className="text-sm font-semibold text-gray-800 hover:text-gray-900 mt-0.5 ml-8"
            onClick={services}
          >
          Services
          </button>
        ...
        <div className="hidden lg:block " style={{ color: '#33805D' }}>
          ...
          <button
            type="button"
            className="rounded-md bg-green-800 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-green/80 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-black"
            onClick={logout}
          >
            Logout
          </button>
          ...
          <button
            type="button" 
            className="rounded-md bg-green-800 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-green/80 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-black mr-7"
            // style={{ backgroundcolor: '#33805D' }}
          >
            Login
          </button>
